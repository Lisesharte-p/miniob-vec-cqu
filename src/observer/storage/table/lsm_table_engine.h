...
public:
  ...
  RC create_index(Trx *trx, const FieldMeta *field_meta, const char *index_name, bool is_vector_index = false, int lists = -1, int probes = -1) override { return RC::UNIMPLEMENTED; }
